<?php
// HTTP
define('HTTP_SERVER', 'http://tdirect.dev2.local/admin/');
define('HTTP_CATALOG', 'http://tdirect.dev2.local/');

// HTTPS
define('HTTPS_SERVER', 'http://tdirect.dev2.local/admin/');
define('HTTPS_CATALOG', 'http://tdirect.dev2.local/');
